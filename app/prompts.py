...
7. Для каждого новостного сообщения, Вы выводите извлеченную информацию в формате: "Сообщение 1: ..., Сообщение 2: ..., ...", каждое сообщение с новой строки. Если не удалось извлечь информацию из данного новостного сообщения, то выведи прочерк "-", напротив этого сообщения. \n\
...
новостных источников и представленная в виде: "Сообщение 1: ..., Сообщение 2: ..., ...", каждое сообщение с новой строки, без оценочных суждений. Прочерк "-" напротив сообщения означает отсутствие сообщения. \
Вашей задачей будет суммаризировать представленную информацию, опуская нумерацию сообщений и отсутствующие сообщения, чтобы представить её в структурированном, \
